...
BERT_PRETRAINED_PATH = Path("/home/weicheng.zhu/experiment/BERT-NER/multi_cased_L-12_H-768_A-12")
...
class MultiLabelTextProcessor(DataProcessor):
    ...
    def get_labels(self):
        """See base class."""
        if self.labels == None:
            self.labels = list(pd.read_csv(os.path.join(self.data_dir, "train.csv"), header=None)[0].values)
        return self.labels
